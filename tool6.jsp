...
<div class="container-fluid background-color">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a  href="tool6.jsp" class="nav-link active">Methylation</a></li>
		...
		<section class="text-center">
		  <div class="templatemo_headerimage">
		    <div class="flexslider">
		      <h2>Analyzing methylation differences among different "Sene_Signature"groups</h2>
		    </div>
		  </div>				
		</section>
		<br/>
...
<div class="fs-5 fw-bold">All differentially methylated CpG sites between High "Sene_Signature" group and Low "Sene_Signature" group</div>
...
<div class="row">
<div class="col">
<img src="images/tool6Re1.png" style="width:600px"/>
</div>
<div class="col">
<img src="images/tool6Re2.png" style="width:600px"/>
</div>
</div>
...
// });
$('#example').DataTable({
	ajax: 'tool6Re/data/tool6Table.json'
})
</script>
		<!-- start footer -->
